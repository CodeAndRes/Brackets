...
Ejemplos de uso:
  ...
  python main.py --debug                    # Información de debug
    ...
    parser.add_argument(
        "--directory", "-d",
        default=".",
        help="Directorio donde buscar y crear archivos (por defecto: directorio actual)"
    )
    ...
    # Crear manager
    manager = BitacoraManager(args.directory)
    ...
    if args.weekly:
        ...
        debug_files_in_directory(args.directory)
        sys.exit(0)
        ...
        if not os.path.exists(filepath):
            filepath = os.path.join(args.directory, args.analyze)
